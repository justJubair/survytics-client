...
const Banner = () => {
    return(
        <div>
           ...
           <div className=" absolute flex items-center justify-center px-4 bottom-36 md:bottom-16 lg:bottom-20 lg:px-0">
            {/* text content */}
            ...
            {/* animation */}
            <div>
               <img className="w-96 lg:w-[450px]" src={bannerAnime2} alt="" />
            </div>
           </div>
        </div>
    )}
