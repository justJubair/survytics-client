  ...
  return (
    <div className="flex flex-col-reverse items-center justify-center md:flex-row px-4">
      ...
      <div className="mt-32 w-full md:w-1/2 lg:w-1/3 md:mt-0">
        <h1 className="text-2xl md:text-4xl font-bold">Unlock Exclusive Insights: Elevate Your Survey Experience with <span className="text-green-600">Pro Memberships!</span></h1>
      </div>
      {/* animation */}
